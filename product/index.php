...
<section id="container">
    <div class="inner">
		<div class="breadcrumbs">
			<a href="#">Главная</a>    &raquo;   <a href="#">Женская одежда</a>  &raquo;     <span>Платья</span>
		</div>
					...
					<div class="product-right">
						<div class="product-inner">
							<div class="product-left-inner">
								<h1>Коктейльное платье</h1>
								<div class="price">
									<span class="price-old">3 890 руб.</span>
						...
						<div class="haracther"><span>Артикул:</span> DSP-224-41t</div>
						<div class="haracther"><span>Цвет:</span> Темно-синий</div>
						<div class="haracther"><span>Длина:</span> 100-102 см (зависит от размера)</div>
						<div class="haracther"><span>Состав:</span> эластан 5%, вискоза 75%, нейлон 20%</div>

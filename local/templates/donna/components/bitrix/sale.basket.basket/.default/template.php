...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<div id="basket-root" class="bag-content" style="opacity: 0;">
		<h1><?$APPLICATION->ShowTitle()?></h1>
		<div class="my-orders" id="basket-item-list">
			<table class="table-bag" id="basket-item-table">
				<thead>
					<tr id="basket-item-table-head"></tr>
				</thead>
			</table>
			<div data-entity="basket-total-block"></div>
			<a href="<?=$arParams["EMPTY_BASKET_HINT_PATH"]?>" class="buy-next"><?=Loc::getMessage("SBB_EMPTY_BASKET_HINT")?></a>
		</div>
	</div>
	<?

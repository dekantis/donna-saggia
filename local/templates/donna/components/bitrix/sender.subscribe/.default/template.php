...
?>
<div class="subscribe-section"  id="sender-subscribe">
<?
...
?>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		...
		<div class="subscribe">
			...
			<input id="bx_subscribe_btn_<?=$buttonId?>" type="submit" name="submit" value="" />
		</div>
...
?>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		...
		<?endif;?>
		<div class="subscribe">
			<input type="email" name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
			<input id="bx_subscribe_btn_<?=$buttonId?>" type="submit" name="submit" value="" />
		</div>
	</form>
<?

		...
		<div class="product-inner">
			<div class="product-left-inner">
				...
				<div class="price">
						...
						<div class="price-new" id="<?=$itemIds["PRICE_ID"]?>">
			...
			<? if ($arResult["COLORS"]) : ?>
				<div class="product-color">
					<div class="haracther"><span><?=GetMessage("CHOOSE_COLOR")?>:</span></div>
						<div class="images-color">
							<? foreach ($arResult["COLORS"] as $color) : ?>
								<a href="<?=$color["DETAIL_PAGE_URL"]?>" class="<?=($arResult["ID"] == $color["ID"] ? 'active' : '')?>">
									<img src="<?=$color["PREVIEW_PICTURE"]["src"]?>" alt="">
								</a>
							<? endforeach; ?>
						</div>
					</div>
					...
					<div class="sizes-left">
						<? if ($haveOffers) : ?>
							...
							<? foreach ($arResult["SKU_PROPS"] as $skuProperty) : ?>
								<?
								if (!isset($arResult['OFFERS_PROP'][$skuProperty['CODE']]) || $skuProperty["CODE"] != "SIZES_CLOTHES")
								{
									continue;
								}
								...
								<div data-entity="sku-line-block">
									<div class="haracther"><span><?=GetMessage("CHOOSE_SIZE")?></span></div>
									...
									<a href="#"><?=GetMessage("DETERMINE_SIZE")?></a>
								</div>
								<? $i++; ?>
							<? endforeach; ?>
						<? endif; ?>
